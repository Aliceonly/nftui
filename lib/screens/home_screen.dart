...
import 'package:nftui/screens/nft_screen.dart';
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    '@Zoey Rise',
                                    style: TextStyle(
                                        fontSize: 14.r, color: Colors.black54),
                                  )
                                ],
                              ),
                            ),
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          BottomNavigationBarItem(
              label: 'Home',
              icon: BottomIcon(icon: Iconsax.home_15, isActive: false)),
          BottomNavigationBarItem(
              label: 'Discover',
              icon: BottomIcon(icon: Iconsax.discover_1, isActive: false)),
          BottomNavigationBarItem(
              label: 'Add',
              icon: BottomIcon(icon: Iconsax.add_square, isActive: false)),
          BottomNavigationBarItem(
              label: 'Shop',
              icon: BottomIcon(icon: Iconsax.shop, isActive: false)),
          BottomNavigationBarItem(
              label: 'Wallet',
              icon: BottomIcon(icon: Iconsax.wallet_3, isActive: false))
        ],
      ),
    );
  }
...
class BottomIcon extends StatelessWidget {
  const BottomIcon({super.key, required this.icon, this.isActive = false});
  final IconData icon;
  final bool isActive;
